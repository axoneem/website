  ...
  return (
    <section className='relative min-h-[100dvh] flex items-end'>
      <div className="absolute inset-0 z-0">
        <div className="scroll-driven-background absolute overflow-hidden z-10 brightness-50 inset-0">
          <div className="absolute inset-0">
            <Animation />
          </div>
        </div>
      </div>
      <div className="relative z-50 w-full pb_6 px-6 lg:px-8">
        <div className="hero-content-card max-w-7xl mx-auto">
          <div className="hero-text-container py_24">
            <h1 
